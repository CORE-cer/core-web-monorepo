...
`,
  ...
  binance: [
    {
      title: 'Binance: Show all Buy and Sell events',
      query: `SELECT *
FROM TICKER
WHERE Buy OR Sell`,
    },
    {
      title: 'Binance: Price movements above threshold',
      query: `SELECT *
FROM TICKER
WHERE Buy AS b
FILTER b[price > 50000]`,
    },
  ],
  kraken: [
    {
      title: 'Kraken: Show all Buy and Sell events',
      query: `SELECT *
FROM TICKER
WHERE Buy OR Sell`,
    },
    {
      title: 'Kraken: Volume analysis',
      query: `SELECT *
FROM TICKER
WHERE Buy AS b
FILTER b[volume_24h > 1000]`,
    },
  ],
};
