...
import { String_literal_or_regexpContext } from './CEQLQueryParser';
...
import { RegexpContext } from './CEQLQueryParser';
import { Regexp_alternationContext } from './CEQLQueryParser';
import { Regexp_expContext } from './CEQLQueryParser';
import { Regexp_elementContext } from './CEQLQueryParser';
import { Regexp_groupContext } from './CEQLQueryParser';
import { ParenthesisContext } from './CEQLQueryParser';
import { QuantifierContext } from './CEQLQueryParser';
import { QuantityContext } from './CEQLQueryParser';
import { QuantExactContext } from './CEQLQueryParser';
import { QuantRangeContext } from './CEQLQueryParser';
import { QuantMinContext } from './CEQLQueryParser';
import { QuantMaxContext } from './CEQLQueryParser';
import { AtomContext } from './CEQLQueryParser';
import { CharacterClassContext } from './CEQLQueryParser';
import { CcAtomContext } from './CEQLQueryParser';
import { CcRangeContext } from './CEQLQueryParser';
import { CcSingleContext } from './CEQLQueryParser';
import { CcLiteralContext } from './CEQLQueryParser';
import { CcEscapesContext } from './CEQLQueryParser';
import { CcOtherContext } from './CEQLQueryParser';
import { LiteralContext } from './CEQLQueryParser';
import { EscapesContext } from './CEQLQueryParser';
import { OtherContext } from './CEQLQueryParser';
import { SharedAtomContext } from './CEQLQueryParser';
import { Regexp_numberContext } from './CEQLQueryParser';
...
export default class CEQLQueryParserListener extends ParseTreeListener {
   ...
   * @param ctx the parse tree
   */
  enterString_literal_or_regexp?: (ctx: String_literal_or_regexpContext) => void;
  /**
   * Exit a parse tree produced by `CEQLQueryParser.string_literal_or_regexp`.
   * @param ctx the parse tree
   */
  exitString_literal_or_regexp?: (ctx: String_literal_or_regexpContext) => void;
  /**
   ...
   * @param ctx the parse tree
   */
  enterQuantExact?: (ctx: QuantExactContext) => void;
  /**
   * Exit a parse tree produced by `CEQLQueryParser.quantExact`.
   * @param ctx the parse tree
   */
  exitQuantExact?: (ctx: QuantExactContext) => void;
  /**
   ...
   * @param ctx the parse tree
   */
  enterQuantMax?: (ctx: QuantMaxContext) => void;
  /**
   * Exit a parse tree produced by `CEQLQueryParser.quantMax`.
   * @param ctx the parse tree
   */
  exitQuantMax?: (ctx: QuantMaxContext) => void;
  /**
   ...
   * @param ctx the parse tree
   */
  enterEscapes?: (ctx: EscapesContext) => void;
  /**
   * Exit a parse tree produced by `CEQLQueryParser.escapes`.
   * @param ctx the parse tree
   */
  exitEscapes?: (ctx: EscapesContext) => void;
  /**
   ...
   * @param ctx the parse tree
   */
  enterSharedAtom?: (ctx: SharedAtomContext) => void;
  /**
   * Exit a parse tree produced by `CEQLQueryParser.sharedAtom`.
   * @param ctx the parse tree
   */
  exitSharedAtom?: (ctx: SharedAtomContext) => void;
  /**
   * Enter a parse tree produced by `CEQLQueryParser.regexp_number`.
   * @param ctx the parse tree
   */
  enterRegexp_number?: (ctx: Regexp_numberContext) => void;
  /**
   * Exit a parse tree produced by `CEQLQueryParser.regexp_number`.
   * @param ctx the parse tree
   */
  exitRegexp_number?: (ctx: Regexp_numberContext) => void;
}
