...
const HitItem: React.FC<HitItemProps> = ({ qid, data, onHitClick, onComplexEventClick, selected, selectedComplexEventIndex, expanded, onExpandedChange }) => {
  ...
  return (
    ...
    >
      ...
      <CardContent>
        ...
        {/* Always show the first complex event */}
        {
          <Box sx={{ mt: 1 }}>
            <Paper
              onClick={(e) => {
        ...
        {/* Show remaining complex events when expanded */}
